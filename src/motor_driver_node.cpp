...
std::string decodeErrorBits(uint32_t error_status) {
  ...
  // Check error bits
  if (error_status & ERROR_ESTOP)
    result += "ERROR_ESTOP ";
  if (error_status & ERROR_TEMP)
    result += "ERROR_TEMP ";
  if (error_status & ERROR_TEMP2)
    result += "ERROR_TEMP2 ";
  if (error_status & ERROR_LBATHIGH)
    result += "ERROR_LBATHIGH ";
  if (error_status & ERROR_LBATLOW)
    result += "ERROR_LBATLOW ";
  if (error_status & ERROR_FAULTM1)
    result += "ERROR_FAULTM1 ";
  if (error_status & ERROR_FAULTM2)
    result += "ERROR_FAULTM2 ";
  if (error_status & ERROR_SPEED1)
    result += "ERROR_SPEED1 ";
  if (error_status & ERROR_SPEED2)
    result += "ERROR_SPEED2 ";
  if (error_status & ERROR_POS1)
    result += "ERROR_POS1 ";
  if (error_status & ERROR_POS2)
    result += "ERROR_POS2 ";
  if (error_status & ERROR_CURRENTM1)
    result += "ERROR_CURRENTM1 ";
  if (error_status & ERROR_CURRENTM2)
    result += "ERROR_CURRENTM2 ";

  // Check warning bits
  if (error_status & WARN_OVERCURRENTM1)
    result += "WARN_OVERCURRENTM1 ";
  if (error_status & WARN_OVERCURRENTM2)
    result += "WARN_OVERCURRENTM2 ";
  if (error_status & WARN_MBATHIGH)
    result += "WARN_MBATHIGH ";
  if (error_status & WARN_MBATLOW)
    result += "WARN_MBATLOW ";
  if (error_status & WARN_TEMP)
    result += "WARN_TEMP ";
  if (error_status & WARN_TEMP2)
    result += "WARN_TEMP2 ";
  if (error_status & WARN_S4)
    result += "WARN_S4 ";
  if (error_status & WARN_S5)
    result += "WARN_S5 ";
  if (error_status & WARN_CAN)
    result += "WARN_CAN ";
  if (error_status & WARN_BOOT)
    result += "WARN_BOOT ";
  if (error_status & WARN_OVERREGENM1)
    result += "WARN_OVERREGENM1 ";
  if (error_status & WARN_OVERREGENM2)
    result += "WARN_OVERREGENM2 ";
